    ...
    <div class="container-xl">
        ...
        <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown d-none d-md-flex me-3">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-card" data-bs-popper="none">
                    <div class="card">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                    <span class="avatar avatar-sm" style="background-image: url({{auth()->user()->profile_image_thumbnail}})"></span>
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    <a href="{{ route('manager.account.my-account') }}" class="dropdown-item">
